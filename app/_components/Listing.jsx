    ...
    <div className="bg-gray-100 p-4 rounded-lg shadow-md">
      <div className="p-3 flex gap-6 items-center bg-white rounded-lg shadow-sm">
        ...
        <Button
          ...
          className="flex gap-2 bg-blue-500 hover:bg-blue-600 text-white"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-6">
        {listing?.length > 0
          ? listing.map((item, index) => (
              <div
                key={index}
                className="p-3 hover:border hover:border-primary cursor-pointer rounded-lg bg-white shadow-md"
              >
                <Image
                  alt="Listing Image"
